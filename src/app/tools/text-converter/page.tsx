...
export const metadata: Metadata = generateToolSEO('text-converter', 'Text Converter')
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-3xl p-8 shadow-2xl ring-4 ring-white/10">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">
                Free Text Converter Online — Professional Tool
              </h1>
              <ToolSEO
                toolId="text-converter"
                toolName="Text Converter"
                toolDescription="Professional Text Converter for accurate and fast results. Free to use, no registration required."
                useCases={["for writers","for developers","for content creators","for students"]}
              />
              <div className="mt-8">
                <TextConverterTool />
              </div>
