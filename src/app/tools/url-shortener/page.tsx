...
export const metadata: Metadata = {
  title: "URL Shortener Tool | Rehman Farouq Portfolio",
  description: "Create short, memorable URLs from long links. Generate unique short codes and manage your shortened URLs with ease.",
  openGraph: {
    title: "URL Shortener Tool | Rehman Farouq Portfolio",
    description: "Create short, memorable URLs from long links. Generate unique short codes and manage your shortened URLs with ease.",
    url: "https://rehmanfarouq.site/tools/url-shortener",
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-pink-600 dark:text-pink-400">URL Shortener</span>
            </div>
          </div>
        </div>
      </nav>
