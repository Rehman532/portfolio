...
export const metadata: Metadata = {
  title: "Color Converter Tool | Rehman Farouq Portfolio",
  description: "Convert between HEX, RGB, and HSL color formats instantly. Generate random colors and copy color codes for your design projects.",
  openGraph: {
    title: "Color Converter Tool | Rehman Farouq Portfolio",
    description: "Convert between HEX, RGB, and HSL color formats instantly. Generate random colors and copy color codes for your design projects.",
    url: "https://rehmanfarouq.site/tools/color-converter",
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-purple-600 dark:text-purple-400">Color Converter</span>
            </div>
          </div>
        </div>
      </nav>
