...
export const metadata: Metadata = {
  title: "Unit Converter Tool | Rehman Farouq Portfolio",
  description: "Convert between different units of measurement including length, weight, temperature, and data storage. Support for multiple conversion categories.",
  openGraph: {
    title: "Unit Converter Tool | Rehman Farouq Portfolio",
    description: "Convert between different units of measurement including length, weight, temperature, and data storage. Support for multiple conversion categories.",
    url: "https://rehmanfarouq.site/tools/unit-converter",
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-orange-600 dark:text-orange-400">Unit Converter</span>
            </div>
          </div>
        </div>
      </nav>
