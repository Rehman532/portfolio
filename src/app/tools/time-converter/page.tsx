...
export const metadata: Metadata = {
  title: "Time Converter Tool | Rehman Farouq Portfolio",
  description: "Convert timestamps between Unix timestamp and human-readable dates. Format dates in multiple formats and convert between timezones.",
  openGraph: {
    title: "Time Converter Tool | Rehman Farouq Portfolio",
    description: "Convert timestamps between Unix timestamp and human-readable dates. Format dates in multiple formats and convert between timezones.",
    url: "https://rehmanfarouq.site/tools/time-converter",
  },
}
